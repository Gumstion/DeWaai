...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 01 feb 2017 om 13:38
-- Serverversie: 5.7.14
-- PHP-versie: 5.6.25
...
INSERT INTO `cursus` (`cursus_id`, `begindatum`, `einddatum`, `aantal`, `soort_id`) VALUES
(1, '2017-02-02', '2017-02-15', 3, 2);
...
INSERT INTO `schip` (`schip_id`, `ontwerp`, `naam`, `plaatsen`, `averij`, `soort_id`) VALUES
(500, '16-kwadraat', 'Hendrica', 5, 0, 1),
(802, 'Draak', 'Brechtje', 4, 1, 2),
(1054, 'Schouw', 'Aaltje', 10, 0, 3);
...
INSERT INTO `soortcursus` (`soort_id`, `cursussoort`, `prijs`, `beschrijving`) VALUES
(1, 'Beginner', 500, 'Lekker makkelijk!'),
(2, 'Gevorderden', 700, 'Iets lastiger!'),
(3, 'Wadtochten', 800, 'Lekker over de wadden varen!');
...
(3, 'j@j.nl', 'j', 'j', '$2y$12$IPdObSBR90T6NWIprWPLMOrZGOhWE3G8AB5TI7p7CQnIlDLp/vjMS', 1, 'j', 'j', '1', 2),
...
--
ALTER TABLE `soortcursus`
  MODIFY `soort_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
